...
DESCRIPTION = """
AttckDef — a single-container attack/defence CTF range.

One vulnerable service (`notestore`), one simulated gameserver planting
flags every tick, a public flag-ID feed, a submission server, and a
scoreboard. Analyze the published attack data, find the flaw, exploit the
live service, and submit flags before they expire.
"""
